...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hybrid | 0.886 | 0.633 | 0.600 | 0.452 | 0.130 | 0.633 | 277.9 |
| graph_lite | 0.886 | 0.624 | 0.569 | 0.437 | 0.126 | 0.624 | 354.7 |
...
| prerequisite | 10 | 0.800 | 0.400 | 0.428 | 0.283 |
| multi_hop | 10 | 0.800 | 0.417 | 0.470 | 0.324 |
...
| prerequisite | 10 | 0.800 | 0.400 | 0.378 | 0.265 |
...
- **PASS** `graph_lite_p95_within_budget` — actual `354.7`, expected `<= 500 ms`
