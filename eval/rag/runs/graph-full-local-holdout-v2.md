...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hybrid | 0.400 | 0.144 | 0.248 | 0.183 | 0.073 | 0.144 | 387.7 |
| graph_lite | 0.400 | 0.144 | 0.248 | 0.183 | 0.073 | 0.144 | 503.6 |
...
- **FAIL** `graph_lite_p95_within_budget` — actual `503.6`, expected `<= 500 ms`
