...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hybrid | 0.486 | 0.281 | 0.324 | 0.231 | 0.057 | 0.281 | 411.5 |
| graph_lite | 0.486 | 0.281 | 0.324 | 0.231 | 0.057 | 0.281 | 442.5 |
...
- **PASS** `graph_lite_p95_within_budget` — actual `442.5`, expected `<= 500 ms`
