...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hybrid | 0.867 | 0.600 | 0.517 | 0.434 | 0.167 | 0.600 | 712.6 |
| graph_lite | 0.867 | 0.600 | 0.551 | 0.446 | 0.167 | 0.600 | 448.4 |
...
- **PASS** `graph_lite_p95_within_budget` — actual `448.4`, expected `<= 500 ms`
