...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hybrid | 0.886 | 0.624 | 0.570 | 0.437 | 0.127 | 0.624 | 1028.2 |
| graph_lite | 0.886 | 0.624 | 0.585 | 0.443 | 0.126 | 0.624 | 423.8 |
...
- **PASS** `graph_lite_p95_within_budget` — actual `423.8`, expected `<= 500 ms`
