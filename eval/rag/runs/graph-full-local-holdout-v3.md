...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hybrid | 0.400 | 0.144 | 0.248 | 0.183 | 0.073 | 0.144 | 428.3 |
| graph_lite | 0.400 | 0.144 | 0.248 | 0.183 | 0.073 | 0.144 | 409.4 |
...
- **PASS** `graph_lite_p95_within_budget` — actual `409.4`, expected `<= 500 ms`
