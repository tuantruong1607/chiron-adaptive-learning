...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hybrid | 0.486 | 0.281 | 0.324 | 0.231 | 0.057 | 0.281 | 417.9 |
| graph_lite | 0.486 | 0.281 | 0.324 | 0.231 | 0.057 | 0.281 | 489.6 |
...
- **PASS** `graph_lite_p95_within_budget` — actual `489.6`, expected `<= 500 ms`
